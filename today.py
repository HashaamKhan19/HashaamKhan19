...
USER_NAME = os.environ['USER_NAME'] # 'HashaamKhan19'
...
if __name__ == '__main__':
    """
    Hashaam Khan (HashaamKhan19), 2022-2025
    """
    print('Calculation times:')
    # define global variable for owner ID and calculate user's creation date
    # e.g {'id': 'MDQ6VXNlcjU3MzMxMTM0'} and 2019-11-03T21:15:07Z for username 'HashaamKhan19'
    ...
    total_loc, loc_time = perf_counter(loc_query, ['OWNER', 'COLLABORATOR', 'ORGANIZATION_MEMBER'], 7, True)
