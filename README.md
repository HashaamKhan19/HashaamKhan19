...
```txt
From: 23 July 2025 - To: 24 February 2026

TypeScript        311 hrs 23 mins       --------------------->>>>   83.05 %
JavaScript        25 hrs 14 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.73 %
JSON              11 hrs 27 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.05 %
Markdown          9 hrs 27 mins         ->>>>>>>>>>>>>>>>>>>>>>>>   02.52 %
Bash              4 hrs 23 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   01.17 %
```
