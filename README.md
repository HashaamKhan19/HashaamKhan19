...
```txt
From: 23 July 2025 - To: 10 September 2026

TypeScript        383 hrs 23 mins       ------------------->>>>>>   73.68 %
JavaScript        32 hrs 20 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.22 %
Markdown          25 hrs 50 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.97 %
JSON              22 hrs 38 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.35 %
Python            15 hrs 47 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.04 %
```
