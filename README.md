...
```txt
From: 23 July 2025 - To: 27 February 2026

TypeScript        311 hrs 23 mins       --------------------->>>>   81.69 %
JavaScript        25 hrs 14 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.62 %
JSON              12 hrs 37 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.31 %
Markdown          10 hrs 53 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   02.86 %
Python            4 hrs 38 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   01.22 %
```
