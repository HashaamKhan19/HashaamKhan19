...
```txt
From: 23 July 2025 - To: 25 February 2026

TypeScript        311 hrs 23 mins       --------------------->>>>   82.90 %
JavaScript        25 hrs 14 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.72 %
JSON              11 hrs 27 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.05 %
Markdown          10 hrs 4 mins         ->>>>>>>>>>>>>>>>>>>>>>>>   02.68 %
Bash              4 hrs 25 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   01.18 %
```
