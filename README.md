...
```txt
From: 23 July 2025 - To: 25 July 2026

TypeScript        360 hrs 52 mins       ------------------->>>>>>   76.38 %
JavaScript        28 hrs 17 mins        -->>>>>>>>>>>>>>>>>>>>>>>   05.99 %
Markdown          21 hrs                ->>>>>>>>>>>>>>>>>>>>>>>>   04.45 %
JSON              18 hrs 59 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.02 %
Python            15 hrs 9 mins         ->>>>>>>>>>>>>>>>>>>>>>>>   03.21 %
```
