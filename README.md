...
```txt
From: 23 July 2025 - To: 28 April 2026

TypeScript        311 hrs 31 mins       -------------------->>>>>   78.94 %
JavaScript        25 hrs 18 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.42 %
JSON              14 hrs 10 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.59 %
Python            12 hrs 52 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.26 %
Markdown          12 hrs 6 mins         ->>>>>>>>>>>>>>>>>>>>>>>>   03.07 %
```
