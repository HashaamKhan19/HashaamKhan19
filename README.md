...
```txt
From: 23 July 2025 - To: 31 March 2026

TypeScript        311 hrs 31 mins       -------------------->>>>>   79.85 %
JavaScript        25 hrs 14 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.47 %
JSON              13 hrs 26 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.45 %
Markdown          11 hrs 47 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.02 %
Python            9 hrs 50 mins         ->>>>>>>>>>>>>>>>>>>>>>>>   02.52 %
```
