...
```txt
From: 23 July 2025 - To: 12 August 2026

TypeScript        370 hrs 56 mins       ------------------->>>>>>   75.30 %
JavaScript        32 hrs 1 min          -->>>>>>>>>>>>>>>>>>>>>>>   06.50 %
Markdown          22 hrs 31 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.57 %
JSON              19 hrs 56 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.05 %
Python            15 hrs 47 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.21 %
```
