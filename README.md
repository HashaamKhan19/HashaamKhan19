...
```txt
From: 23 July 2025 - To: 19 August 2026

TypeScript        378 hrs 13 mins       ------------------->>>>>>   74.81 %
JavaScript        32 hrs 2 mins         -->>>>>>>>>>>>>>>>>>>>>>>   06.34 %
Markdown          25 hrs 4 mins         ->>>>>>>>>>>>>>>>>>>>>>>>   04.96 %
JSON              20 hrs 48 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.11 %
Python            15 hrs 47 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.12 %
```
