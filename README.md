...
```txt
From: 23 July 2025 - To: 14 August 2026

TypeScript        373 hrs 4 mins        ------------------->>>>>>   75.07 %
JavaScript        32 hrs 2 mins         -->>>>>>>>>>>>>>>>>>>>>>>   06.45 %
Markdown          23 hrs 49 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.79 %
JSON              20 hrs 18 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.09 %
Python            15 hrs 47 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.18 %
```
