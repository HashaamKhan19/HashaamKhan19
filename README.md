...
```txt
From: 23 July 2025 - To: 20 February 2026

TypeScript        311 hrs 23 mins       --------------------->>>>   83.46 %
JavaScript        25 hrs 14 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.77 %
JSON              11 hrs 27 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   03.07 %
Markdown          8 hrs 5 mins          ->>>>>>>>>>>>>>>>>>>>>>>>   02.17 %
Bash              4 hrs 23 mins         >>>>>>>>>>>>>>>>>>>>>>>>>   01.18 %
```
