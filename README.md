...
```txt
From: 23 July 2025 - To: 21 July 2026

TypeScript        354 hrs 54 mins       ------------------->>>>>>   77.13 %
JavaScript        27 hrs 51 mins        -->>>>>>>>>>>>>>>>>>>>>>>   06.05 %
Markdown          18 hrs 53 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.10 %
JSON              18 hrs 32 mins        ->>>>>>>>>>>>>>>>>>>>>>>>   04.03 %
Python            15 hrs                ->>>>>>>>>>>>>>>>>>>>>>>>   03.26 %
```
